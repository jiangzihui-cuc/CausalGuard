...
| [19 工作导引](19-work-guide.md) | 仓库补充：打开仓库先看 |
| [20 开源代码复用调研与接入建议](20-open-source-reuse-guide.md) | 阶段1起：开源选型、许可证与接入边界 |
...
| 19 | [工作导引](19-work-guide.md) | 打开仓库先看：下一步做什么、改哪个文件 | 两人共同 |
| 20 | [开源代码复用调研与接入建议](20-open-source-reuse-guide.md) | 开源选型、许可证判定、接入与登记流程 | 成员 A |
| 21 | [双人并行开发分工与 Git 协作规范](21-parallel-work-allocation-plan.md) | 阶段分工、Fake/Real 契约、分支与 PR 规范 | 两人共同 |
...
| [20 开源复用建议](20-open-source-reuse-guide.md) | 选型、GPL/MIT 边界、固定 commit、许可证登记；你主责 |
| [THIRD_PARTY_NOTICES.md](../THIRD_PARTY_NOTICES.md) | 第三方来源/版本/许可/修改；你生成，成员 B 汇总复核 |
...
**两人共同复核**：15 验收清单、16 演示与发布、17 任务看板、18 风险清单、20 开源复用建议、21 并行分工与协作规范、THIRD_PARTY_NOTICES。
...
- 引入任何第三方代码或数据前，先更新 [20 开源复用建议](20-open-source-reuse-guide.md) 与 [THIRD_PARTY_NOTICES.md](../THIRD_PARTY_NOTICES.md)，固定版本并核对许可证后再导入。
